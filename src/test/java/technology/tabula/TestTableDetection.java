...
public class TestTableDetection {
    ...
    public void testDetectionOfTables() throws Exception {
        ...
        ObjectExtractor extractor = new ObjectExtractor(pdfDocument, pdfDocument.getPage(1));
        ...
        NurminenDetectionAlgorithm detectionAlgorithm = new NurminenDetectionAlgorithm(pdfDocument);
