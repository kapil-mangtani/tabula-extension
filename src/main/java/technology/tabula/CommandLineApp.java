    ...
    public void extractTables(CommandLine line) throws ParseException {
        ...
        try {
            ...
            ObjectExtractor oe = line.hasOption('s') ?
                    new ObjectExtractor(pdfDocument, pdfDocument.getPage(1), line.getOptionValue('s')) :
                    new ObjectExtractor(pdfDocument, pdfDocument.getPage(1));
            ...
            while (pageIterator.hasNext()) {
                ...
                case BASIC:
                    if (line.hasOption('g')) {
                        ...
                        DetectionAlgorithm detector = new NurminenDetectionAlgorithm(pdfDocument);
