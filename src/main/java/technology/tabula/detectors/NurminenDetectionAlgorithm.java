...
public class NurminenDetectionAlgorithm implements DetectionAlgorithm {
    ...
    // we need the document to initialize an instance of PDFRenderer class
    // for converting page to image
    ...
    public NurminenDetectionAlgorithm(PDDocument document) {
    ...
    public List<Rectangle> detect(Page page) {
        ...
        try {
            image = renderer.renderImageWithDPI(page.getPageNumber(), 144, ImageType.GRAY);
        } catch (IOException e) {
